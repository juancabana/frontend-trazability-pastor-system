...
export default function AdminPastorReportsPage() {
  ...
  const cumplimiento = Math.round((reports.length / daysInMonth) * 100);
  ...
  return (
    <div className="max-w-[1000px] mx-auto">
      ...
      <div className="flex items-center gap-3 mb-5">
        <button
          onClick={() => router.push('/admin/pastores')}
          ...
          {calendarDays.map((day, i) => {
            ...
            return (
              <div
                ...
                onClick={() =>
                  report &&
                  router.push(`/admin/pastor/${pastorId}/report/${dateStr}`)
                }
        ...
        <div className="divide-y divide-gray-50">
          {reports.map((r) => (
            <button
              key={r.id}
              onClick={() =>
                router.push(`/admin/pastor/${pastorId}/report/${r.date}`)
              }
