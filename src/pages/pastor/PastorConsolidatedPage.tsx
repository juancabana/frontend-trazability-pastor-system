...
export default function PastorConsolidatedPage() {
  ...
  const stats = [
    ...
    },
    {
      ...
      value: `${compliance}%`,
      sub: 'del mes',
      color: compliance >= 70 ? 'text-emerald-600' : 'text-amber-600',
      bg: compliance >= 70 ? 'bg-emerald-50' : 'bg-amber-50',
    },
    {
      icon: Activity,
      label: 'Registros',
  ...
  return (
    <div className="max-w-[900px] mx-auto">
      ...
      {consolidated?.categories?.map((cat) => {
        ...
        const totalHrs = cat.subcategories.reduce(
                        ...
                        >
                          ...
                          <div className="sm:hidden">
                            ...
                            <div className="flex flex-wrap gap-2">
                              <span className="text-xs bg-gray-100 text-gray-900 font-medium px-2 py-0.5 rounded-md">
                                {sub.totalQuantity}{' '}
                                {UNIT_LABELS[sub.unit] || sub.unit}
                              </span>
                              {sub.totalHours > 0 && (
                                <span className="text-xs bg-orange-50 text-orange-600 px-2 py-0.5 rounded-md">
                                  {sub.totalHours.toFixed(1)}h
                                </span>
                              )}
                            </div>
                    ...
                    <div className="px-5 py-3 border-t-2 border-gray-200 bg-gray-50/50">
                      ...
                      <div className="sm:hidden flex items-center justify-between">
                        ...
                        <div className="flex gap-2">
                          <span className="text-xs font-semibold text-gray-900 bg-gray-200 px-2 py-0.5 rounded-md">
                            {totalQty}
                          </span>
                        </div>
                      </div>
